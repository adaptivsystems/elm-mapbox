...
However, since a published library can't have ports in it, you will need to do some setup. The easiest way to do this is to copy [this file into your app](https://github.com/adaptivsystems/elm-mapbox/blob/main/examples/MapCommands.elm). You can see the module docs for that [here](https://github.com/adaptivsystems/elm-mapbox/blob/main/docs/MapCommands.md).
